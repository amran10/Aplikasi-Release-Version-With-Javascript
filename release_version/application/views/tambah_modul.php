...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
  ...
  if(isset($data_cek))
  {
      ...
      $versi = $row->versi;
  ?>
  <?php echo form_open_multipart(site_url('c_versi/create_modul')); ?>
   <div class="col-xs-12">
                <div class="col-md-12" >
                  ...
                  <div>
                      <input readonly="readonly" id="m_versi" name="m_versi" type="text" value="<?php echo $row->versi; ?>" placeholder="0.0.0" class="form-control input-md">
                    </div>
                  </div>
                  <div class="form-group">
                    <div align="left" >
