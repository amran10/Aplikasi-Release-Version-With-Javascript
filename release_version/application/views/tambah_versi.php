...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
  ...
  <?php echo form_open_multipart(site_url('c_versi/create_versi')); ?>
   <div class="col-xs-12">
                <div class="col-md-12" >
                  ...
                  <div>
                      <input required="required" id="versi" name="versi" type="text" value="" placeholder="0.0.0" class="form-control input-md">
                    </div>
                  </div>
                  <div class="form-group">
                    <div align="left" >
                  ...
                  <div >
                      <input id="tanggal" name="tanggal" type="date" value="" placeholder="" class="form-control input-md">
                    </div>
                  </div>
              </div>
            </div>
            ...
            <!-- <h3> Actions</h3> -->
              <div id="field">
                <div id="field0">
                  ...
                  <div>
                      <input id="add_menu" name="add_menu[]" type="text" value="" placeholder="" class="form-control input-md">
                    </div>
                  </div>
                  <!-- File Button --> 
                  <div class="form-group">
                  ...
                  <div>
                      <input id="add_release" name="add_release[]" type="text" value="" placeholder="" class="form-control input-md"> 
                    </div>
                  </div>
                </div>
                <!-- Button -->
