   ...
   foreach ($wika as $show) { ?>
    ...
    <table class="table table-bordered" style="margin-top: 10px; height: 0px; width: 950px;">
          <tbody>
            ...
            <tr <?php if ($cnt_versi == $show->versi) { echo "hidden" ; } $cnt_versi = $show->versi ; ?> >
              <td width="100">
                <h5>HCIS Versi <?php echo $show->versi; ?></h5>
              </td>
              <td width="200">
                <h5>( <b></b><?php echo $show->tanggal; ?>) </h5>
              </td>
            </tr>
          </thead>
        </tbody>
        ...
        <table>
            ...
            <tr align="left">
              ...
              <td colspan="2" width="401">
                <h6><i><?php echo $show->add_modul; ?></i></h6>
              </td>
            </tr>
            <tr align="left">
              <td>
              ...
              <td colspan="2" width="401">
                <h6><i><?php echo $show->add_menu; ?></i></h6>
              </td>
            </tr>
            <tr align="left">
              <td width="200">
              ...
              <td colspan="2" width="401">
                <h6><i><?php echo $show->add_release; ?></i></h6>
              </td>
            </tr>
          </tbody>
        </thead>
