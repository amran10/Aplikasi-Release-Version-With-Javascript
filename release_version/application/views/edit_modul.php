...
<!------ Include the above in your HEAD tag ---------->
  ...
  ?>
  <?php echo form_open_multipart('c_wika/simpanedit/'.$id_modul)?>
   <div class="col-xs-12">
                <!-- <div class="col-md-12" >
                  ...
                  <div>
                      <input readonly="readonly" id="" name="" type="text" value="<?php echo $row->versi; ?>" placeholder="0.0.0" class="form-control input-md">
                    </div>
                  </div>
                  <div class="form-group">
                    <div align="left" >
                ...
                <div id="field0">
                  ...
                  <div>
                     <select id="add_modul" name="add_modul" class="form-control">
                            <option value="<?php echo $row->add_modul; ?>"><?php echo $row->add_modul; ?></option>
